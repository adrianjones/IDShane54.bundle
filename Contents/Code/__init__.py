...
FEED_URL = 'http://internationaldepartures.podbean.com/feed/'

####################################################################################################
def Start():

	ObjectContainer.art = R(ART)
	ObjectContainer.title1 = 'International Departures with Shane 54'
	TrackObject.thumb = R(ICON)

####################################################################################################     
@handler('/music/podcast/internationaldepartures', 'International Departures with Shane 54', thumb=ICON, art=ART)
def MainMenu():
